...
bind("SUPER", "D", exec_cmd("pkill rofi || true; $HOME/.config/hypr/scripts/RofiFocusedWallpaperLink.sh >/dev/null 2>&1 || true; rofi -show drun -modi drun, filebrowser, run, window"), { description = "App launcher" })
...
bind("SUPER", "Return", exec_cmd("$HOME/.config/hypr/scripts/LaunchTerminal.sh \"alacritty\""), { description = "Open terminal" })
bind("SUPER", "E", exec_cmd("$HOME/.config/hypr/scripts/LaunchFileManager.sh \"thunar\" \"alacritty\""), { description = "File manager" })
...
bind("SUPER CTRL", "S", exec_cmd("$HOME/.config/hypr/scripts/RofiFocusedWallpaperLink.sh >/dev/null 2>&1 || true; rofi -show window"), { description = "Window switcher" })
...
bind("ALT", "xf86audiolowervolume", exec_cmd("$HOME/.config/hypr/scripts/Volume.sh --dec-precise"), { description = "Volume down precise", locked = true, repeating = true })
...
bind("SUPER SHIFT", "right", dispatch("resizeactive", "50 0"), { description = "Resize right (+50)", repeating = true })
